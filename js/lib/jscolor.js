...
var jscolor = {
	...
	if (!jscolor.imgLoaded[filename]) {
	    ...
	    jscolor.imgLoaded[filename].src = jscolor.getMediaDir() + filename;
	}
    },
	...
	function drawPicker(x, y) {
	    ...
	    p.padM.style.backgroundImage = "url('" + jscolor.getMediaDir() + "cross.gif')";
	    p.padM.style.backgroundRepeat = "no-repeat";
	    p.sldM.style.backgroundImage = "url('" + jscolor.getMediaDir() + "arrow.gif')";
	    p.sldM.style.backgroundRepeat = "no-repeat";
	    p.pad.style.backgroundImage = "url('" + jscolor.getMediaDir() + padImg + "')";
